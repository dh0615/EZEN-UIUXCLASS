...
// clientX : 74 => 스크롤을 인식하지 않은 상태에서 단순히 웹브라우저 상의 마우스 위치값을 계속 반환

// pageX : 74 => 웹페이지를 스크롤하게 되면 값이 바뀜
// if, 스크롤이 발생될 수 밖에 없는 페이지 않에서 스크롤이 내려가는 상황에서도 나의 X 혹은 Y좌표값을 찾아오고 싶다면, 반드시 pageX 속성값을 사용해야한다!

// screenX : -823

// 현재 마우스가 위치해 있는 좌표값
// 이동 후 마우스가 위치해있는 좌표값
// 현재 좌표값 => 이동 후 좌표값의 속도 비율 = 1:1
